...
for i in range(0, len(l1)):
    l2.append(0)
df=pd.read_csv('C:\\Users\\prajwal meshram\\Documents\\APPTITUDE\\Prototype.csv')
...
tr = pd.read_csv("C:\\Users\\prajwal meshram\\Documents\\APPTITUDE\\Prototype-1.csv")
...
w2 = Label(root, justify=CENTER, text="personal DOCTOR", fg="Red", bg="White")
w2.config(font=("Times", 30, "bold italic"))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=CENTER, text="A Project by PRAJWAL MESHRAM", fg="Pink", bg="Blue")
w2.config(font=("Times", 30, "bold italic"))
...
destreeLb = Label(root, text="RandomForest", fg="Red", bg="pink")
